...
export const metadata: Metadata = {
  title: 'About Us | Boise Roofing Co',
  description: 'Learn about Boise Roofing Co. Local roofing experts serving the Treasure Valley. Licensed, insured, and committed to quality service.',
  alternates: { canonical: 'https://boise-roofing-company.com/about-us' },
}
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">About Boise Roofing Co</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Your trusted local roofing experts in the Treasure Valley.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Boise Roofing Co is a locally owned and operated roofing company serving homeowners throughout the Treasure Valley. We provide complete roofing services including roof repair, roof replacement, roof installation, and preventive maintenance.</p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                ...
                <p className="text-gray-600">Fully licensed roofing contractors with comprehensive insurance coverage.</p>
              </div>
              <div className="text-center">
