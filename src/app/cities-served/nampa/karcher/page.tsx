...
export const metadata: Metadata = {
  title: 'Roofing Karcher Nampa | Top Shelf',
  description: 'Roofing services in Karcher, Nampa, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['roofing Karcher', 'roofing Karcher Nampa', 'Karcher nampa roofing'],
  alternates: {
    canonical: 'https://boise-roofing-company.com/cities-served/nampa/karcher',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Looking for roofing in Karcher? You've found the right team.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Roofing in Karcher, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Roofing for Karcher area homes and businesses. All types served.</p>
                <p>
