...
export const metadata: Metadata = {
  title: 'Roofing Services Middleton Idaho | Roof Repair & Installation | Boise Roofing Co',
  description: 'Professional roofing services in Middleton, Idaho. Roof repair, replacement, installation, inspection & maintenance. Licensed & insured. Free estimates. Call (208) 768-3987.',
  keywords: ['roofing Middleton', 'roof repair Middleton Idaho', 'roof replacement Middleton', 'roof installation Middleton', 'roofing contractor Middleton'],
  alternates: {
  ...
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/middleton-roofing.webp"
          alt="Roofing Services in Middleton, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Roofing Services in Middleton</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Professional roofing installation, repair, and maintenance services for Middleton homes and businesses. Licensed, insured, and committed to quality.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Middleton Roofing Services</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Middleton is a charming small town between Star and Caldwell. With hot summers reaching into the 90s and cold winters, your roof protects your home from extreme weather year-round. When you need roofing service in Middleton, Boise Roofing Co is here to help.</p>
              <p>We've served Middleton homeowners for years, handling everything from emergency storm damage repairs to complete roof replacements. Our crews know Middleton homes and the unique roofing challenges they face in Idaho's high desert climate.</p>
            </div>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Roofing Service in Middleton?</h3>
