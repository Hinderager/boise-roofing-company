...
export const metadata: Metadata = {
  title: 'Roofing The Bench Boise | Top Shelf',
  description: 'Roofing services in The Bench, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['roofing The Bench', 'roofing The Bench Boise', 'The Bench boise roofing'],
  alternates: {
    canonical: 'https://boise-roofing-company.com/cities-served/boise/bench',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Roofing in The Bench
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            The Bench residents trust us for roofing. Here's why.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Roofing in The Bench, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Bench homes face the same Idaho weather as everywhere else, but the neighborhood's elevation means more wind exposure. We provide roofing solutions built to last.</p>
                <p>
