...
export const metadata: Metadata = {
  title: 'Roofing North End Boise | Top Shelf',
  description: 'Roofing services in North End, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['roofing North End', 'roofing North End Boise', 'North End boise roofing'],
  alternates: {
    canonical: 'https://boise-roofing-company.com/cities-served/boise/north-end',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Roofing in North End
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving North End with professional roofing services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Roofing in North End, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Many North End homes have original or aging roofs that need attention. Our roofing team is experienced with the variety of roof styles found on historic and mid-century homes throughout the neighborhood.</p>
                <p>
