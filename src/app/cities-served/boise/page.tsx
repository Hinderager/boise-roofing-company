...
export const metadata: Metadata = {
  title: 'Roofing Services Boise Idaho | Roof Repair & Installation | Boise Roofing Co',
  description: 'Professional roofing services in Boise, Idaho. Roof repair, replacement, installation, inspection & maintenance. Licensed & insured. Free estimates. Call (208) 768-3987.',
  keywords: ['roofing Boise', 'roof repair Boise Idaho', 'roof replacement Boise', 'roof installation Boise', 'roofing contractor Boise'],
  alternates: {
    canonical: 'https://boise-roofing-company.com/cities-served/boise',
  },
}

const neighborhoods = ['Downtown Boise', 'North End', 'East End', 'Bench', 'West Boise', 'Southeast Boise', 'Southwest Boise', 'Harris Ranch', 'Warm Springs', 'Boise Highlands', 'Collister', 'State Street']
  ...
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/boise-roofing.webp"
          alt="Roofing Services in Boise, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Roofing Services in Boise</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Professional roofing installation, repair, and maintenance services for Boise homes and businesses. Licensed, insured, and committed to quality.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Boise Roofing Services</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Boise is the state capital and largest city in Idaho. With hot summers reaching 100°F and cold winters dropping below freezing, your roof protects your home from extreme weather year-round. When you need roofing service in Boise, Boise Roofing Co is here to help.</p>
              <p>We've served Boise homeowners for years, handling everything from emergency storm damage repairs to complete roof replacements. Our crews know Boise homes and the unique roofing challenges they face in Idaho's high desert climate.</p>
            </div>
            ...
            <h3 className="text-2xl font-bold text-dark-blue mb-6">Why Boise Homeowners Choose Us</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700"><strong>Local Service:</strong> We're based in the Treasure Valley and know Boise well.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700"><strong>Fast Response:</strong> Same-day service available for Boise residents.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Roofing Service in Boise?</h3>
