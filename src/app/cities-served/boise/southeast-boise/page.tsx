...
export const metadata: Metadata = {
  title: 'Roofing Southeast Boise Boise | Top Shelf',
  description: 'Roofing services in Southeast Boise, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['roofing Southeast Boise', 'roofing Southeast Boise Boise', 'Southeast Boise boise roofing'],
  alternates: {
    canonical: 'https://boise-roofing-company.com/cities-served/boise/southeast-boise',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Roofing in Southeast Boise
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need roofing services in the Southeast Boise area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Roofing in Southeast Boise, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Southeast Boise roofs face the same weather challenges as the rest of the valley. We provide quality roofing services for homes and businesses.</p>
                <p>
