...
export const metadata: Metadata = {
  title: 'Frequently Asked Questions | Boise Roofing Co',
  description: 'Frequently Asked Questions - Helpful roofing information from Boise Roofing Co.',
  alternates: { canonical: 'https://boise-roofing-company.com/resources/faq' },
}
