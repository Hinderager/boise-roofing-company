...
export const metadata: Metadata = {
  title: "Tile Roofing Installation Boise | Top Shelf Roofing | (208) 768-3987",
  description: "Expert tile roof installation. Concrete and clay tile. Beautiful, long-lasting roofing. Call (208) 768-3987.",
};
