...
export const metadata: Metadata = {
  title: 'Contact Us | Boise Roofing Co',
  description: 'Contact Boise Roofing Co for roofing service in the Treasure Valley. Call (208) 768-3987 for fast service.',
  alternates: { canonical: 'https://boise-roofing-company.com/contact' },
}
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Emergency Roof Repairs Available</p>
